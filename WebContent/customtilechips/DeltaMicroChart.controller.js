...
(function() {
	...
	sap.ui.controller("customtilechips.DeltaMicroChart", {
		...
		successHandleFn: function(oResult) {
			...
			var aKeys = [
				...
				"value1", "value2", "title1", "title2", "displayValue1",
				"displayValue2", "deltaDisplayValue", "color"
				// End additional data //
			];
