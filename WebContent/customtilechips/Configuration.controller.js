...
(function() {
	...
	sap.ui.controller("customtilechips.Configuration", {
		...
		onConfigurationInputChange: function(oControlEvent) {
			sap.ushell.components.tiles.utilsRT.checkInput(this.getView(), oControlEvent);
		},
		...
		onAfterRendering: function() {
			//            sap.ushell.components.tiles.utilsRT.updateTooltipForDisabledProperties(this.getView());
